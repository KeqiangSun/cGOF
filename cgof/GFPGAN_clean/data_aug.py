...
def main():
    ...
    paths_ = '/home/kqsun/Tasks/tmp_zn/data/0517/pick31_1024'
    resp = paths_ +'_pre1'
    ...
    for i in tqdm(range(len(paths))):
        gt_path = os.path.join(paths_,paths[i])
        ...
        cv2.imwrite(os.path.join(resp,paths[i]),img_lq*255)
...
def pre_aug(gt_path):
    ...
    img_bytes = file_client.get(gt_path)
    img_gt_ = imfrombytes(img_bytes, float32=True)
    img_gt = cv2.resize(img_gt_,(1024,1024))
