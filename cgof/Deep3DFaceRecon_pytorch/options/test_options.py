...
class TestOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--coeff_static_path', type=str, default="/home/kqsun/Tasks/pigan/Deep3DFaceRecon_pytorch/coeff_distribution.npz", help='folder for test images.')
