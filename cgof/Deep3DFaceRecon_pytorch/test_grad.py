...
"""
# modify Deep3DFaceRecon_pytorch/deep3dfacerecon_opt.py
# then python Deep3DFaceRecon_pytorch/test_grad.py
import sys
...
def main(rank, opt, name='examples'):
    ...
    for i in range(len(im_path)):
        ...
        visualizer.display_current_results(
            visuals, 0, opt.epoch, dataset=name.split(os.path.sep)[-1],
