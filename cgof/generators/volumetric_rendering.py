...
def transform_sampled_points(
        ...
        mode='normal', return_cam2word=False, camera_shift=(0, 0, 0)):
    ...
    camera_origin[..., 0] += camera_shift[0]
    camera_origin[..., 1] += camera_shift[1] # -0.012
    camera_origin[..., 2] += camera_shift[2]
...
def get_initial_rays_trig_from_depth2(
        n, num_steps, device, fov, resolution, ray_start, ray_end,
        d_input, m_input, thick_ratio, norm_mode='vec_len'):
