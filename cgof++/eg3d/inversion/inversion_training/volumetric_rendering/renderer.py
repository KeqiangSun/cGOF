...
# from training import volumetric_rendering as VR
...
class ImportanceRenderer(torch.nn.Module):
    def __init__(self):
        super().__init__()
        self.ray_marcher = MipRayMarcher2()#getattr(ray_marcher, options.get('ray_marcher_module', 'RayMarcher'))()
        self.plane_axes = torch.nn.Parameter(generate_planes(), requires_grad=False)
