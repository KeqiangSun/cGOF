...
# python gen_videos_from_given_latent_code.py --outdir=out --trunc=0.7 --npy_path ./projector_out/00018_w/00018_w.npy   --network=./networks/ffhqrebalanced512-64.pkl --sample_mult=2
