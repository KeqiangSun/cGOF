...
class MetricOptions:
    def __init__(self, G=None, face_recon=None, G_kwargs={}, dataset_kwargs={}, dataset_kwargs2={}, num_gpus=1, rank=0, device=None, progress=None, cache=True):
        assert 0 <= rank < num_gpus
        self.G              = G
        self.face_recon     = face_recon
        self.G_kwargs       = dnnlib.EasyDict(G_kwargs)
        self.dataset_kwargs = dnnlib.EasyDict(dataset_kwargs)
        self.dataset_kwargs2 = dnnlib.EasyDict(dataset_kwargs2)
...
def compute_feature_stats_for_generator(opts, detector_url, detector_kwargs, rel_lo=0, rel_hi=1, batch_size=64, batch_gen=None, **stats_kwargs):
    ...
    while not stats.is_full():
        ...
        for _i in range(batch_size // batch_gen):
            ...
            #----------------------------------------------------------------------------
            # Modified by Sun et al.
            img = G(z=z, c=next(c_iter), face_recon=opts.face_recon, **opts.G_kwargs)['image']
            #----------------------------------------------------------------------------
