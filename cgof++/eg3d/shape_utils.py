...
def convert_ply_to_obj(ply, obj):
...
def convert_sdf_samples_to_ply(
    ...
    mesh_points = mesh_points * voxel_size - cube_length / 2
    ...
    if ply_filename_out.endswith('.obj'):
        convert_ply_to_obj(ply_data, ply_filename_out)
    else:
