...
def project(
    ...
    for step in tqdm(range(num_steps)):
        ...
        ws = (w_opt + w_noise)
        synth_images = G.synthesis(ws, c, face_recon=face_recon, noise_mode='const')['image']
        ...
        mse_loss = torch.nn.MSELoss(reduction="mean")(synth_images, target_images)
        loss = dist + mse_loss + reg_loss * regularize_noise_weight
